...
CREATE VIEW Biene (Kennzahl,Gattung) AS SELECT Kennzahl,Gattung FROM ( SELECT  Koenigin.Kennzahl,Koenigin.Gattung  FROM Koenigin UNION SELECT  Arbeiterin.Kennzahl,Arbeiterin.Gattung  FROM Arbeiterin ) as tmp;
